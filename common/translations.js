...
"bg": {
  ...
  "t_formathelp":      '<a href="http://us.php.net/manual/en/function.date.php">Справка за формата</a>',
  "t_formathelplong":  '<a href="http://us.php.net/manual/en/function.date.php">Справка за формата</a> (не се поддържат: T, e, o, u)',
  "t_version":         "Версия 1.28 (2009-03-02)",
  "t_about":           "За гаджета",
